                        ...
                        <table>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <%: Html.TextBox("IPStsIdentifier", "https://adatum/trust", new { size = "55" })%>
                                    </td>
                                </tr>                                
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <%: Html.TextBox("IPStsAddress", "https://localhost/Adatum.SimulatedIssuer.v2/", new { size = "55" })%>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                 ...
                                 <tr>
                                    <td>
                                        SQL Database Instance (optional):
                                    </td>
                                    <td>
